...
const api: HelmApi = {
	...
	daemon: {
		...
		retryKnowledgeDelivery: (itemId, deliveryId) => invokeHelm('daemon:retryKnowledgeDelivery', itemId, deliveryId),
		recoverKnowledgeDelivery: itemId => invokeHelm('daemon:recoverKnowledgeDelivery', itemId),
		aiPass: (id, pass) => invokeHelm('daemon:aiPass', id, pass),
		createItem: body => invokeHelm('daemon:createItem', body),
		assignItem: (id, body) => invokeHelm('daemon:assignItem', id, body),
	...
	tabs: {
		...
		onPrevious: listener => subscribe('tab:previous', listener),
		onNext: listener => subscribe('tab:next', listener),
