...
- **Task and Plan documents share `ReadingPage`** (`DetailSubpages.tsx`): one `PushHeader`, scroll owner, loading state, and 16px body gutter. Do not hand-compose their page frames or add page-specific outer padding; only their document content differs.
