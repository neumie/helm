...
| `--group-blue/purple/pink/red/orange/green/cyan` | palette in `theme-presets.ts` | none | User-selected terminal-group text + continuous 2px marker (§3.18) |
