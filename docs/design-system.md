...
| `--group-blue/purple/pink/red/orange/green/cyan` | palette in `theme-presets.ts` | 15% resting / 22% hover | User-selected terminal-group first-slot identity (§3.18) |
